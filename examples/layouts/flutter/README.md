...
[`lib/ui/flexbox-interactive.slint`](lib/ui/flexbox-interactive.slint) is the UI packaged with the app.
...
cd ../examples/layouts/flutter
fvm dart pub get
fvm dart run build_runner build --delete-conflicting-outputs

# First time only — create a platform runner:
fvm flutter create . --platforms=macos --project-name layouts
