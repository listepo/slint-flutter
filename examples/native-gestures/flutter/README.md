...
[`lib/ui/native-gestures.slint`](lib/ui/native-gestures.slint) is the UI packaged with the app.
...
cd ../examples/native-gestures/flutter
fvm dart pub get
fvm dart run build_runner build --delete-conflicting-outputs

# First time only — create a platform runner:
fvm flutter create . --platforms=macos --project-name native_gestures
